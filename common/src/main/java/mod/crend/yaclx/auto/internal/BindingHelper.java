...
/**
 * Helper class to easily create YACL bindings based on a type parameter.
 */
class BindingHelper<T> {
	...
	// String is weird and requires new object creation under certain circumstances. Other classes may require the same.
	...
	// Lists are special and can be reversed
